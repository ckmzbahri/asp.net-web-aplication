<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cateringicerik.aspx.cs" Inherits="WebApplication1.cateringicerik" %>
         ...
         <div class="services_grid">
		      ...
		      <asp:Repeater ID="Repeater1" runat="server">
                 <ItemTemplate>
                     ...
                     <asp:Label ID="Label1" runat="server" Text='<%# Eval("menu_adi") %>'></asp:Label>
                     <br />
                         
                     <asp:Image ID="Image1" runat="server" Height="118px" ImageUrl='<%# Eval("menu_fotograf") %>' Width="337px" />
                     <br />
                     <br />
                   <asp:Label ID="Label5" runat="server" Text="Menü İçerik:"></asp:Label>   <asp:Label ID="Label2" runat="server" Text='<%# Eval("menu_icerik") %>'></asp:Label>
                     <br />
                     <br />
                     <asp:Label ID="Label4" runat="server" Text="Menü Fiyatı:"></asp:Label>         <asp:Label ID="Label3" runat="server" Text='<%# Eval("menu_fiyat") %>'></asp:Label>
