...
{
    public partial class cateringicerik : System.Web.UI.Page
    {
        public string kose;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
           ...
           // OleDbConnection conn = new OleDbConnection("Provider=Microsoft.Jet.OleDb.4.0;Data Source=" + Server.MapPath("~/webprojesi.mdb"));
            menu_id = Request.QueryString["menu_id"];// query string string olarak veriyi istiyoruz
            conn.Open();
            OleDbCommand cmd1 = new OleDbCommand("Select menu_adi,menu_icerik,menu_fiyat,menu_fotograf from yemekler where menu_id=@menu_id", conn);
            cmd1.Parameters.AddWithValue("@menu_id", menu_id);
