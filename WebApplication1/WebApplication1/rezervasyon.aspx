<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="rezervasyon.aspx.cs" Inherits="WebApplication1.rezervasyon" %>
		          ...
		          <table class="auto-style1">
                      <tr>
                          <td class="auto-style2" colspan="2">
                              <span class="auto-style4"><strong class="auto-style5">MEKAN BİLGİLERİ:</strong></span><br />
                              <br />
                              ...
                              <asp:Button ID="Button4" runat="server" Text="BIRAK" Width="90px" Height="32px" OnClick="Button4_Click" />
                              <br />
                              <br />
                          </td>
                          <td>&nbsp;</td>
                      ...
                      <tr>
                          <td class="auto-style6" colspan="2">
                              <br />
                              <span class="auto-style4"><strong class="auto-style5">&nbsp;SANATÇI BİLGİLERİ:</strong></span><asp:GridView ID="GridView2" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" OnSelectedIndexChanged="GridView2_SelectedIndexChanged">
                                  <AlternatingRowStyle BackColor="White" />
                                  <Columns>
                                      <asp:ButtonField CommandName="SELECT" Text="SEÇ    " />
                                  </Columns>
                              ...
                              <asp:Button ID="Button3" runat="server" Text="BIRAK" Width="90px" Height="32px" OnClick="Button3_Click" />
                              <br />
                          </td>
                          <td>&nbsp;</td>
                      </tr>
...
&nbsp;</td>
                      ...
                      <tr>
                          <td class="auto-style7" colspan="2">
                              <br />
                              <span class="auto-style4"><strong class="auto-style5">&nbsp;YEMEK MENÜSÜ BİLGİLERİ:</strong></span><asp:GridView ID="GridView3" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" OnSelectedIndexChanged="GridView3_SelectedIndexChanged">
                                  <AlternatingRowStyle BackColor="White" />
                                  <Columns>
                                      <asp:ButtonField CommandName="select" Text="SEÇ    " />
                                  </Columns>
...
&nbsp; <span class="auto-style4"><strong class="auto-style5">&nbsp;REZERVASYON BİLGİLERİ:</strong></span><br />
                      ...
                      <tr>
                          <td class="auto-style2" colspan="2">
                              <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                              <asp:Button ID="Button1" runat="server" Text="REZERVASYON YAP" Width="145px" Height="32px" OnClick="Button1_Click" />
&nbsp;&nbsp;&nbsp;
