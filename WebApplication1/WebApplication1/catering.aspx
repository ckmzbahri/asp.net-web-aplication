<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="catering.aspx.cs" Inherits="WebApplication1.catering" %>
    ...
    <ItemTemplate>
		         			<div class="image group marketing">
									<div class="grid images_3_of_1">
										 <li><a href="cateringicerik.aspx?menu_id=<%#Eval("menu_id")%>">MENÜ BİLGİLERİNİN TAMAMI
       <asp:Image ID="Image1" ImageUrl='<%#Eval("menu_fotograf") %>'  runat="server" /><%-- EVAL VERMEK MEKANLAR TABLOSUNA BAĞLANDIĞIMIZDA VERİYİ NEREDEN ALACAĞINI SÖYLER--%>
                                             <h4><%#Eval("menu_adi") %> </></h4>
									</div>
