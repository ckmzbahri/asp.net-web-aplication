<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="kulllanici.aspx.cs" Inherits="WebApplication1.kulllanici" %>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="auto-style14">
                        ...
                        KULLANICI BİLGİLERİ</span></strong></div>
                </div>
            </div>
        </div>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
          <table class="auto-style1">
              ...
              <tr>
                  ...
                  <td class="auto-style10">
                      <br />
                      <asp:Label ID="Label7" runat="server" Text="MEVCUT KULLANICI ADI:"></asp:Label>
                      <br />
                  </td>
                  <td class="auto-style5">
              ...
              <tr>
                  ...
                  <td class="auto-style11">
                      <br />
                      <br />
                      <asp:Label ID="Label2" runat="server" Text="MEVCUT ŞİFRE:"></asp:Label>
                  </td>
              ...
              <tr>
                  ...
                  <td class="auto-style12">
                      <br />
                      <asp:Label ID="Label3" runat="server" Text="YENİ KULLANICI ADI:"></asp:Label>
                      <br />
                  </td>
                  <td>
              ...
              <tr>
                  ...
                  <td class="auto-style12">
                      <br />
                      <br />
                      <asp:Label ID="Label4" runat="server" Text="YENİ ŞİFRE:"></asp:Label>
                  </td>
                  <td>
                      <br />
                      <br />
              ...
              <tr>
                  ...
                  <td class="auto-style12">
                      <br />
                      <br />
                      <asp:Label ID="Label5" runat="server" Text="YENİ ŞİFRE TEKRAR:"></asp:Label>
                  </td>
                  <td>
                      <br />
                      <br />
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <asp:Button ID="iptal0" runat="server" Text="  SİL  " OnClick="iptal0_Click" Width="71px" />
                      <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      <asp:Button ID="kaydet0" runat="server" Text="YENİ ADMİN EKLE" OnClick="kaydet0_Click" Width="177px" />
                  </td>
                  <td>&nbsp;</td>
              </tr>
              <tr>
