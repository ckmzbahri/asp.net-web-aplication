...
namespace WebApplication1
{
    public partial class mekanlar : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            conn.Open();
            OleDbCommand komut1 = new OleDbCommand("Select * from mekan", conn);
            OleDbDataReader oku = komut1.ExecuteReader();
            Repeater1.DataSource = oku;
            Repeater1.DataBind();
            conn.Close();
            conn.Open();
            OleDbCommand k1 = new OleDbCommand("Select * from duyurular", conn);
            OleDbDataReader oku1 = k1.ExecuteReader();
