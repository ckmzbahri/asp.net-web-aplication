...
{
    public partial class sanatcilaricerik : System.Web.UI.Page
    {
        public string kose;
        public string sanatci_id;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            sanatci_id = Request.QueryString["sanatci_id"];// query string string olarak veriyi istiyoruz
            conn.Open();
            OleDbCommand cmd1 = new OleDbCommand("Select sanatci_ad,sanatci_muzik,sanatci_yas,sanatci_video,sanatci_fotograf from sanatcilar where sanatci_id=@sanatci_id", conn);
            cmd1.Parameters.AddWithValue("@sanatci_id", sanatci_id);
