<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mekanlaricerik.aspx.cs" Inherits="WebApplication1.mekanlaricerik" %>
		      ...
		      <div class="content_bottom">
		       <asp:Repeater ID="Repeater1" runat="server" OnItemCommand="Repeater1_ItemCommand">
                 <ItemTemplate>
                     ...
                     <asp:Label ID="Label1" runat="server" Text='<%# Eval("mekan_adi") %>'></asp:Label>
                     <br />
                      
                     <asp:Image ID="Image1" runat="server" Height="118px" ImageUrl='<%# Eval("mekan_foto1") %>' Width="337px" />
                     <br />
                     <br />
                     <asp:Label ID="Label2" runat="server" Text='<%# Eval("mekan_adres") %>'></asp:Label>
                     <br />
                     <br />
                     <asp:Label ID="Label3" runat="server" Text='<%# Eval("kapasite") %>'></asp:Label>
